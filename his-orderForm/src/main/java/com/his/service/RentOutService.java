...
public interface RentOutService extends IService<RentOut> {
     ...
     * @return
     */
    Page<RentOut> searchPageByKeyword(Integer current, Integer size, String oddNumbers, List<String> clientIdNumberList, String ofTheTimeStart, String ofTheTimeEnd);
